...
import cat.urv.deim.asm.p2.planificate.ui.blister28.BlisterActivity19;

public class Blister21Activity18 extends AppCompatActivity {
    ImageButton cargarBlisterSiguiente;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blister47);
        cargarBlisterSiguiente=findViewById(R.id.boton_blister47);
    ...
    public void cargarBlister(View view) {
        if(cargarBlisterSiguiente.isClickable()){
            ...
            Intent x = new Intent(this, Blister21Activity19.class);
            startActivity(x);
            finish();
