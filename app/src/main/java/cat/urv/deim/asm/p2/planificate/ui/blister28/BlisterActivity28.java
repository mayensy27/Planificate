...
/// TOMA 29 DIA DE LA PILDRA
        ...
        objEditor.putString("tomaBlister_29", fecha); // dado que a partir de ahora no será la pirmera vez, lo ponemos false
        objEditor.apply();
        objEditor.putInt("dia_29", 29); // dado que a partir de ahora no será la pirmera vez, lo ponemos false
        objEditor.apply();
