...
public class BlisterActivity26 extends AppCompatActivity {
    ImageButton cargarBlisterSiguiente;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blister26);
        cargarBlisterSiguiente=findViewById(R.id.boton_blister26);
    ...
    public void cargarBlister(View view) {
        if(cargarBlisterSiguiente.isClickable()){
            ...
            if(fecha.equals(preferences.getString("tomaBlister_26", ""))){
                ...
                Intent x = new Intent(this, BlisterActivity27.class);
                startActivity(x);
                finish();
                ...
                /// TOMA 27 DIA DE LA PILDRA

                SharedPreferences.Editor objEditor = preferences.edit();
                objEditor.putString("tomaBlister_27", fecha); // dado que a partir de ahora no será la pirmera vez, lo ponemos false
                objEditor.apply();
                objEditor.putInt("dia_27", 27); // dado que a partir de ahora no será la pirmera vez, lo ponemos false
                objEditor.apply();
            }
        }
    }
