...
import cat.urv.deim.asm.p2.planificate.ui.blister28.BlisterActivity9;

public class Blister21Activity8 extends AppCompatActivity {
    ImageButton cargarBlisterSiguiente;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blister37);
        cargarBlisterSiguiente=findViewById(R.id.boton_blister37);
    ...
    public void cargarBlister(View view) {
        if(cargarBlisterSiguiente.isClickable()){
            ...
            Intent x = new Intent(this, Blister21Activity9.class);
            startActivity(x);
            finish();
