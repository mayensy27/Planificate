...
public class BlisterActivity20 extends AppCompatActivity {
    ImageButton cargarBlisterSiguiente;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blister20);

        cargarBlisterSiguiente=findViewById(R.id.boton_blister20);
    ...
    public void cargarBlister(View view) {
        if(cargarBlisterSiguiente.isClickable()){
            ...
            Intent x = new Intent(this, BlisterActivity21.class);
            startActivity(x);
            finish();
