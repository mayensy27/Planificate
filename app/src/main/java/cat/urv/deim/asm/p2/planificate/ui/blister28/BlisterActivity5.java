...
public class BlisterActivity5 extends AppCompatActivity {
    ImageButton cargarBlisterSiguiente;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blister5);

        cargarBlisterSiguiente=findViewById(R.id.boton_blister5);
    ...
    public void cargarBlister(View view) {
        if(cargarBlisterSiguiente.isClickable()){
            ...
            if(fecha.equals(preferences.getString("tomaBlister_5", ""))){
                ...
                Intent x = new Intent(this, BlisterActivity6.class);
                startActivity(x);
                finish();
