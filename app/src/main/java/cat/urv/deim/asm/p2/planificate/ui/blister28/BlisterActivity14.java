...
public class BlisterActivity14 extends AppCompatActivity {
    ImageButton cargarBlisterSiguiente;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blister14);
        cargarBlisterSiguiente=findViewById(R.id.boton_blister14);
    ...
    public void cargarBlister(View view) {
        if(cargarBlisterSiguiente.isClickable()){
            ...
            if(fecha.equals(preferences.getString("tomaBlister_14", ""))){
                ...
                Intent x = new Intent(this, BlisterActivity15.class);
                startActivity(x);
                finish();
