...
public class Blister21Activity14 extends AppCompatActivity {
    ImageButton cargarBlisterSiguiente;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blister43);
        cargarBlisterSiguiente=findViewById(R.id.boton_blister43);
    ...
    public void cargarBlister(View view) {
        if(cargarBlisterSiguiente.isClickable()){
            ...
            if(fecha.equals(preferences.getString("tomaBlister_14", ""))) {
                ...
                Intent x = new Intent(this, Blister21Activity15.class);
                startActivity(x);
                finish();
                ...
                // TOMA 15 DIA DE LA PILDRA


                SharedPreferences.Editor objEditor = preferences.edit();
                objEditor.putString("tomaBlister_15", fecha); // dado que a partir de ahora no será la pirmera vez, lo ponemos false
                objEditor.apply();
                objEditor.putInt("dia_15", 15); // dado que a partir de ahora no será la pirmera vez, lo ponemos false
                objEditor.apply();
            }
